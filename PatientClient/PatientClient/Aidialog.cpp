...
Aidialog::Aidialog(QWidget *p) : QMainWindow(p) {
    ...
    connect(m_send, &QPushButton::clicked, this, &Aidialog::sendMessage);
}

void Aidialog::append(const QString& who, const QString& text) {
...
QByteArray Aidialog::buildBody(const QString& userText) const {
...
void Aidialog::sendMessage() {
    ...
    connect(rp, &QNetworkReply::finished, this, &Aidialog::handleReply);
}
